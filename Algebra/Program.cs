...
namespace Algebra
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			Initialize.InitalizeMenues(out MainMenu, out ExercisesMenu, out ChapterFourOne, out ChapterFive, out ChapterFiveOne, out ChapterFiveTwo, out ChapterFiveThree, out ChapterSix, out ChapterSixOne, out ChapterSixTwo, out ChapterSeven, out ChapterSevenOne, out ChapterSevenTwo, out AfterExerciseMenu);
			...
			// LINKING METHODS
			Initialize.LinkFunctions(ChapterFourOne, ChapterFiveOne, ChapterFiveTwo, ChapterFiveThree, ChapterSixOne, ChapterSixTwo, ChapterSevenOne, ChapterSevenTwo, AfterExerciseMenu);
